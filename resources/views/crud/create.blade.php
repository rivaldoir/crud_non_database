...
<head>
  ...
  <title>Tambah Data — Latihan CRUD</title>
...
<div class="container py-5">
  <div class="card card-soft p-4">
    <h4 class="text-danger mb-4"><i class="fa-solid fa-plus me-2"></i>Tambah Data Baru</h4>
    ...
    <form action="{{ route('crud.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <button class="btn btn-red px-4"><i class="fa-solid fa-save me-2"></i>Simpan</button>
